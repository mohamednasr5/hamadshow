...
(function() {
  ...
  const App = {
    ...
    _setupNavigation() {
      ...
      if (menuToggle) {
        menuToggle.addEventListener('click', () => self._toggleSidebar());
      }

      // Sidebar overlay close
      const sidebarOverlay = document.getElementById('sidebar-overlay');
      if (sidebarOverlay) {
        sidebarOverlay.addEventListener('click', () => self._closeSidebar());
      }
      ...
      if (logoutBtn) {
        logoutBtn.addEventListener('click', () => self._logout());
      }
      ...
      document.addEventListener('click', (e) => {
        ...
        if (menu && !menu.classList.contains('hidden') &&
            !menu.contains(e.target) && !profileBtnEl?.contains(e.target)) {
      ...
      document.addEventListener('server:connected', () => this._updateProfileMenu());
      document.addEventListener('server:disconnected', () => this._updateProfileMenu());
    },
